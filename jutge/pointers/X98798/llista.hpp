...
class Llista { 
  public:
    ...
    /* Pre: El p.i. és una llista L i està ordenada de forma creixent */
    /* Post: El p.i. s'ha modificat afegint x on li correspon per
       mantenir l'ordre creixent; si el punt d'interès de L
       referenciava a un element igual a x, passa a referenciar al
       primer element igual a x; altrament, el punt d'interès no canvia */
